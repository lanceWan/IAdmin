...
<div class="page-bar">
	<ul class="page-breadcrumb">
	    ...
	    <li>
	        <span>{!! trans('labels.breadcrumb.permissionCreate') !!}</span>
	    </li>
	</ul>
</div>
      ...
      <div class="portlet light bordered">
          <div class="portlet-title">
              <div class="caption font-green-haze">
                  ...
                  <span class="caption-subject bold uppercase">{!! trans('labels.breadcrumb.permissionCreate') !!}</span>
              </div>
              <div class="actions">
          ...
          <div class="portlet-body form">
          		@if (isset($errors) && count($errors) > 0 )
					    ...
					    @endif
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/permission')}}">
              		{!! csrf_field() !!}
                  <div class="form-body">
                      <div class="form-group form-md-line-input">
                          <label class="col-md-2 control-label" for="name">{{trans('labels.permission.name')}}</label>
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="name" name="name" placeholder="{{trans('labels.permission.name')}}" value="{{old('name')}}">
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="slug" name="slug" placeholder="{{trans('labels.permission.slug')}}" value="{{old('slug')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="description" name="description" placeholder="{{trans('labels.permission.description')}}" value="{{old('description')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
                      ...
                      <div class="form-group form-md-line-input">
                          ...
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="model" name="model" placeholder="{{trans('labels.permission.model')}}" value="{{old('model')}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
